export const PencilIcon = ({ width, height }: { width: number; height: number }) => (
  <svg width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
    <path
      d='M43.12,12.57L34.58,4a3,3,0,0,0-4.24,0L6.84,27.52a2,2,0,0,0,0,2.82l10,10a2,2,0,0,0,2.82,0L43.12,16.82A3,3,0,0,0,43.12,12.57Z'
      fill='#f9d74a'
    />
